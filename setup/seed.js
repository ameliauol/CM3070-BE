  ...
  try {
    ...
    const programmesQuery = `
      ...
      VALUES
        ...
        ('High-Intensity Interval Training', 2, 'A high-intensity workout combining cardio and strength exercises for a full-body challenge.', 'advanced', 75, 'https://unsplash.com/photos/caucasian-active-handsome-sportsman-working-out-in-fitness-gym-club-attractive-athlete-male-exercise-using-battle-rope-to-lose-weight-and-maintain-muscle-for-health-care-lifestyle-in-fitness-stadium-7DQr-fPDsMU'),
        ...
        ('Yoga for Relaxation', 5, 'A yoga program designed to promote relaxation and flexibility.', 'beginner', 30, 'https://unsplash.com/photos/woman-wearing-black-shirt-sitting-on-green-yoga-mat-GpVak9-cL6E'),
